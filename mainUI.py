...
class Ui_MainWindow(object):
    ...
    def get_basic_input(self):
        ...
        try:
            ...
            if saving_type == 'Random':
                ...
                monthly_savings = 0
                random = False
            basic_data = {self.username:{"basics": {'total': total, 'monthly_savings': monthly_savings, 'daily_savings': daily_savings}}}
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", f"{self.username}'s Cash bank"))
